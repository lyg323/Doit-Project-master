  ...
  <header>
    ...
    <b-modal id="login" class="modal" hide-footer>
      <template #modal-title>
        <div class="layertit"><i class="bi bi-clipboard-check"></i>로그인</div>
      </template>
      <div class="modalcontainer">
        <div class="loginform">
          <label for="id"><i class="bi bi-file-person"></i>아이디</label>
          <b-form-input
            id="id"
            placeholder="아이디를 입력해 주세요"
          ></b-form-input>
          <label for="pass"><i class="bi bi-lock"></i>비밀번호</label>
          <b-form-input
            type="password"
            id="pass"
    ...
    <b-modal id="member" class="modal" hide-footer>
      <template #modal-title>
        <div class="layertit">
          <i class="bi bi-clipboard-check"></i>회원가입
        </div>
      </template>
      <div class="modalcontainer">
        <b-form @submit="Joinmember">
          ...
          >
            <b-form-checkbox value="html" v-model="form.checkedtype"
              >HTML/CSS</b-form-checkbox
            >
            <b-form-checkbox value="javascript" v-model="form.checkedtype"
              >자바스크립트</b-form-checkbox
            >
            <b-form-checkbox value="python" v-model="form.checkedtype"
              >파이썬</b-form-checkbox
            >
            <b-form-checkbox value="Vue.js" v-model="form.checkedtype"
              >Vue.js</b-form-checkbox
            >
            <b-form-checkbox value="angular" v-model="form.checkedtype"
              >앵귤러</b-form-checkbox
            >
            <b-form-checkbox value="react" v-model="form.checkedtype"
              >리액트</b-form-checkbox
            >
            <b-form-checkbox value="data" v-model="form.checkedtype"
              >자료구조/알고리즘</b-form-checkbox
            >
            <b-form-checkbox value="cad" v-model="form.checkedtype"
              >오토캐드</b-form-checkbox
            >
          </b-form-group>
...
export default {
  ...
  methods: {
    goToPage(target) {
      // this: Vue 인스턴스
      // $router: /router/modules/pageRouter.js에 작성된 라우터의 모든 정보
      // currentRoute: 현재 컴포넌트의 라우팅 정보
      // path: 라우팅 정보에서 경로
    ...
    Joinmember(event) {
      ...
      // nextTick() 메서드
      // Vue.js의 DOM 업데이트가 완료되고 나서 추가 작업을 수행하고 싶을 때 사용
      this.$nextTick(() => {
        this.form.id = "";
        this.form.pass = "";
        this.form.mail = "";
